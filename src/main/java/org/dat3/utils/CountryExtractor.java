...
public class CountryExtractor {
        ...
        public static List<Country> extract(String jsonStr) {
            ...
            //moved the currency to a global variable
            //Currency currency = null;
            try {
                JsonArray obj = gson.fromJson(jsonStr, JsonArray.class);
                List<Callable<Country>> taskList = new ArrayList<>();
                ...
                List<Future<Country>> futures = executorService.invokeAll(taskList);
